    ...
    public function up()
    {
        $this->db->exec("
            CREATE TABLE IF NOT EXISTS doc_signature_audit (
                ...
                event_type ENUM('signature_created', 'signature_verified', 'tamper_detected', 'seal_applied', 'hard_copy_uploaded', 'contract_submitted', 'client_signed', 'escalated_to_company', 'company_signed') NOT NULL,
